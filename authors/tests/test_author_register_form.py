...
class AuthorRegisterUnitTest(TestCase):
    ...
    def test_fieds_placeholder(self, field, placeholder):
        form = RegisterForm()
    ...
    @parameterized.expand([
        ...
        ('password', (
            ...
            'one lowercase letter and one number. The '
    ...
    def test_fieds_label(self, field, label):
        form = RegisterForm()
...
class AuthorRegisterIntegrationTest(DjangoTestCase):
    ...
    def test_fields_connot_be_empty(self, field, message):
